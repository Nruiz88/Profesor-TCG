...
interface PokedexSearchModalProps {
  /** Título de la barra superior (ej: "Agregar a buscadas"). */
  title?: string
...
// Modal de búsqueda estilo Pokédex con navegación 100% teclado (cmdk — la
// librería de Vercel/Linear). Busca el catálogo por nombre, número o set y
// agrega la carta al binder o a la wantlist con ↑↓ + ↵.
