      ...
      >
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <h2 className="text-lg font-black tracking-tight text-white">{card.card_name}</h2>
        ...
        {/* Zona hero: carta protagonista + acciones P2P */}
        <div className="relative mt-4 overflow-hidden rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900 to-[#0c1220] p-4">
          {/* Glows decorativos */}
          <div className="pointer-events-none absolute -left-16 -top-16 h-48 w-48 rounded-full bg-rose-500/20 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-16 -right-16 h-48 w-48 rounded-full bg-sky-500/10 blur-3xl" />

          <div className="relative flex flex-col items-center">
            {/* Carta en grande */}
            <div className="w-52 drop-shadow-[0_18px_35px_rgba(0,0,0,0.6)] sm:w-60">
            ...
            {/* Acciones P2P: WhatsApp destacado + copiar */}
            {(withSale || withTrade) && (
              <div className="mt-4 w-full">
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-3 py-3 text-sm font-black text-[#05331a] shadow-lg shadow-emerald-950/50 transition-all hover:brightness-110 disabled:opacity-60"
                  >
                  ...
                  <button
                    ...
                    disabled={sharing !== null}
                    className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-700 bg-slate-900/70 px-3 py-3 text-sm font-bold text-slate-200 transition-colors hover:border-slate-500 hover:text-white disabled:opacity-60"
                  >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                      <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                    {sharing === 'copy' ? 'Generando…' : 'Copiar'}
                  </button>
                </div>
                {shareError && (
            ...
            {/* Precio — debajo de los botones de compartir */}
            <div className="mt-4 w-full">
              <label className="block text-center text-[10px] font-bold uppercase tracking-widest text-slate-500">
                Precio
              </label>
