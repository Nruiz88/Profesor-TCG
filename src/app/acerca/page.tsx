...
export const metadata: Metadata = {
  title: 'Acerca de TCG Claim | Mercado P2P de Cartas TCG & Binder en 3D',
  description:
    'Qué es TCG Claim: el mercado P2P de cartas TCG para comprar, vender y permutar sin comisiones. Digitalizá tu binder en 3D, publicá tus cartas y coordiná por WhatsApp.',
  alternates: { canonical: '/acerca' },
  openGraph: { url: '/acerca' },
